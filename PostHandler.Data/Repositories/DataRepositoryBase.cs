namespace PostHandler.Data.Repositories
{
    ...
    using PostHandler.Foundation.Security;
    ...
    public abstract class DataRepositoryBase<TEntity> : DBConnection, IDataRepository<TEntity> where TEntity : new() 
    {
        ...
        {
            ConnectionString = APIConfigurationManager.Current.APISettings.ReadConnectionString;//AppConfigurationManager.Current.DialerAppSettings.ProdDBConnectionString
        ...
        {
            ParamGuard.ArgumentNotNull(connectionString, "connectionString");
        ...
        protected DataRepositoryBase(IDbConnection connection, ISqlGenerator<TEntity> sqlGenerator)
            : base(connection)
        {
            ParamGuard.ArgumentNotNull(sqlGenerator, "sqlGenerator");
